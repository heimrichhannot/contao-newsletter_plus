 ...
 */
$GLOBALS['TL_DCA']['tl_newsletter_recipients']['list']['operations']['toggle']['button_callback'] = array('tl_newsletter_recipients_plus', 'toggleIcon');
$GLOBALS['TL_DCA']['tl_newsletter_recipients']['config']['ondelete_callback'] = array(array('tl_newsletter_recipients_plus', 'deletePlus'));
$GLOBALS['TL_DCA']['tl_newsletter_recipients']['config']['onsubmit_callback'] = array(array('tl_newsletter_recipients_plus', 'submitPlus'));
$GLOBALS['TL_DCA']['tl_newsletter_recipients']['config']['onload_callback'] = array(array('tl_newsletter_recipients_plus', 'addPlusFields'));
...
class tl_newsletter_recipients_plus extends tl_newsletter_recipients
{
	...
	public function addPlusFields(DataContainer $dc)
	{
		...
		{
			$helper = new NlpInputHelper(false);
